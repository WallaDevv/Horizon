...
template <typename T>
T call_v_func(void* table, int index) {
	return (*(T**)table)[index];
}
class ILocalize {
public:
	wchar_t* find(const char* token_name) {
		typedef wchar_t* (__thiscall* o_fn)(void*, const char*);
		return call_v_func<o_fn>(this, 11)(this, token_name);
	}
};
...
public:
	void create_renderable_handle(void* obj) {
		typedef void(__thiscall* o_fn)(void*, int, int, char, signed int, char);
		call_v_func<o_fn>(this, 0)(this, reinterpret_cast<uintptr_t>(obj) + 0x4, 0, 0, 0xFFFFFFFF, 0xFFFFFFFF);
	}
	void add_renderable(void* obj) {
		typedef void(__thiscall* o_fn)(void*, int, int, int, int, int);
		call_v_func<o_fn>(this, 7)(this, reinterpret_cast<uintptr_t>(obj) + 0x4, 0, 0, 0xFFFFFFFF, 0xFFFFFFFF);
	}
};
