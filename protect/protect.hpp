...
namespace hs {
	...
	_(watermark, "Horizon [Release] \nWelcome"); // Weave Cheat [BETA] \nWelcome, %s\nSubscription ends in: %s
	...
	_(set_abs_angles, "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1"); // 55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8
	...
	//shonax things paster master
	_(d3dx9fix, "shaderapidx9.dll"); 
	_(d3dx9fix_pattern, "A1 ? ? ? ? 50 8B 08 FF 51 0C");
	_(get_econ_item_view, "E8 ? ? ? ? 89 44 24 54"); //E8 ? ? ? ? 89 44 24 54
	_(world_to_screen_matrix, "0F 10 05 ? ? ? ? 8D 85 ? ? ? ? B9"); //0F 10 05 ? ? ? ? 8D 85 ? ? ? ? B9
	_(find_or_create_reference_econ_item, "55 8B EC 51 8B 55 0C 53 56"); //55 8B EC 51 8B 55 0C 53 56 
	_(equip_item_in_loadout, "55 8B EC 83 E4 F8 83 EC 24 83 3D ? ? ? ? ? 53 56 57 8B F9"); //55 8B EC 83 E4 F8 83 EC 24 83 3D ? ? ? ? ? 53 56 57 8B F9
	_(remove_item, "55 8B EC 83 E4 F8 56 57 FF 75 0C 8B F1"); //55 8B EC 83 E4 F8 56 57 FF 75 0C 8B F1
	_(g_c_client_system, "8B 0D ? ? ? ? 6A ? 83 EC 10"); //8B 0D ? ? ? ? 6A ? 83 EC 10
	_(g_c_client_system_find_so_cahce, "55 8B EC 83 E4 F8 83 EC 1C 0F 10 45 08"); //55 8B EC 83 E4 F8 83 EC 1C 0F 10 45 08
	_(g_c_client_system_create_byte, "55 8B EC 51 53 56 8B D9 8D 45 08"); //55 8B EC 51 53 56 8B D9 8D 45 08
	_(get_inventory_item_by_index, "55 8B EC 8B 55 08 83 EC 10 8B C2"); //55 8B EC 8B 55 08 83 EC 10 8B C2
	_(add_econ_item, "55 8B EC 83 E4 F8 A1 ? ? ? ? 83 EC 14 53 56 57 8B F9 8B 08"); //55 8B EC 83 E4 F8 A1 ? ? ? ? 83 EC 14 53 56 57 8B F9 8B 08
	_(inventory_manager, "B9 ? ? ? ? 8D 44 24 10 89 54 24 14"); //B9 ? ? ? ? 8D 44 24 10 89 54 24 14
	_(local_player_inventory, "8B 3D ? ? ? ? 85 FF 0F 84 ? ? ? ? BA"); //8B 3D ? ? ? ? 85 FF 0F 84 ? ? ? ? BA
	_(leaf_system_pattern, "A1 ? ? ? ? FF 50 14 8B 86 ? ? ? ? B9 ? ? ? ? C1 E8 0E 24 01 0F B6 C0 50 0F B7 86 ? ? ? ? 50 A1 ? ? ? ? FF 50 18 8B 86 ? ? ? ? B9 ? ? ? ? C1 E8 0C 24 01 0F B6 C0 50 0F B7 86 ? ? ? ? 50 A1 ? ? ? ? FF 90 ? ? ? ? 8B 0D"); //A1 ? ? ? ? FF 50 14 8B 86 ? ? ? ? B9 ? ? ? ? C1 E8 0E 24 01 0F B6 C0 50 0F B7 86 ? ? ? ? 50 A1 ? ? ? ? FF 50 18 8B 86 ? ? ? ? B9 ? ? ? ? C1 E8 0C 24 01 0F B6 C0 50 0F B7 86 ? ? ? ? 50 A1 ? ? ? ? FF 90 ? ? ? ? 8B 0D
	_(get_item_schema, "A1 ? ? ? ? 85 C0 75 53"); //A1 ? ? ? ? 85 C0 75 53
	_(update_equipped_state, "55 8B EC 8B 45 08 8B D0 C1 EA 10"); //55 8B EC 8B 45 08 8B D0 C1 EA 10
	_(set_custom_name, "E8 ? ? ? ? 8B 46 78 C1 E8 0A A8 01 74 13 8B 46 34"); //E8 ? ? ? ? 8B 46 78 C1 E8 0A A8 01 74 13 8B 46 34
	_(set_custom_desc, "E8 ? ? ? ? 33 DB 39 5E 3C 7E 5E"); //E8 ? ? ? ? 33 DB 39 5E 3C 7E 5E
	_(set_attribute_value, "55 8B EC 83 E4 F8 83 EC 3C 53 8B 5D 08 56 57 6A ?"); //55 8B EC 83 E4 F8 83 EC 3C 53 8B 5D 08 56 57 6A ?
	_(get_static_data, "55 8B EC 51 53 8B D9 8B ? ? ? ? ? 56 57 8B ? ? ? ? ? 85 FF 74 16"); //55 8B EC 51 53 8B D9 8B ? ? ? ? ? 56 57 8B ? ? ? ? ? 85 FF 74 16
	_(set_soc_data, "55 8B EC 83 E4 F0 83 EC 18 56 8B F1 57 8B 86"); //55 8B EC 83 E4 F0 83 EC 18 56 8B F1 57 8B 86
	_(create_econ_item, "C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4"); //C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4
	_(keyvalue_init, "55 8B EC 83 EC 10 53 8B 5D 08 57 8B F9"); //55 8B EC 83 EC 10 53 8B 5D 08 57 8B F9
	_(load_from_buffer, "55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89 4C 24 04"); //55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89 4C 24 04
	_(find_key, "55 8B EC 83 EC 1C 53 8B D9 85 DB"); //55 8B EC 83 EC 1C 53 8B D9 85 DB
	_(get_string, "55 8B EC 83 E4 C0 81 EC ? ? ? ? 53 8B 5D 08"); //55 8B EC 83 E4 C0 81 EC ? ? ? ? 53 8B 5D 08
	_(set_string, "55 8B EC A1 ? ? ? ? 53 56 57 8B F9 8B 08 8B 01"); //55 8B EC A1 ? ? ? ? 53 56 57 8B F9 8B 08 8B 01
	_(set_uint64, "55 8B EC 56 6A 01 FF 75 08"); //55 8B EC 56 6A 01 FF 75 08
	_(equip_wearables, "55 8B EC 83 EC 10 53 8B 5D 08 57 8B F9"); //55 8B EC 83 EC 10 53 8B 5D 08 57 8B F9 
	_(initialize_attributes, "55 8B EC 83 E4 F8 83 EC 0C 53 56 8B F1 8B 86"); //55 8B EC 83 E4 F8 83 EC 0C 53 56 8B F1 8B 86 
	_(file_system_pure, "8B 0D ? ? ? ? 8D 95 ? ? ? ? 6A 00 C6"); //8B 0D ? ? ? ? 8D 95 ? ? ? ? 6A 00 C6
...
namespace fnv_1a {
	...
	struct fnv1a< uint32_t > : public fnv_internal< uint32_t > {
		 static uint32_t hash(char const* string, const uint32_t val = default_offset_basis) {
			unsigned int t = 0;
			for (auto i = 0; i < strlen(string) + 1; t += (int)string[i], i++);
			return t;
			//not save, recode it...
		}
...
//inline std::string g_Modules[90000];
