...
CBaseHandle* IBasePlayer::get_wearables()
{
	static int offset = netvars.GetOffset("DT_BaseCombatCharacter", "m_hMyWearables");
...
Vector IBasePlayer::GetEyePosition()
{
	...
	return this->GetOrigin() + this->GetVecViewOffset();
...
bool IBasePlayer::is_controlling_bot()
{
	static int tt = netvars.GetOffset("DT_CSPlayer", "m_bIsControllingBot");
	return *(bool*)(((DWORD)this + tt));
}
...
C_EconItemView* IBaseCombatWeapon::get_econ_item_view() {
	static auto address = csgo->Utils.FindPatternIDA(GetModuleHandleA(g_Modules[fnv::hash(hs::client_dll::s().c_str())].c_str()), g_Patterns[fnv::hash(hs::get_econ_item_view::s().c_str())].c_str());
	static auto fn_get_econ_item_view = reinterpret_cast<C_EconItemView * (__thiscall*)(void*)>(*reinterpret_cast<uintptr_t*>(address + 1) + address + 5);
	return fn_get_econ_item_view(this);
}
...
CBaseHandle IBaseViewModel::m_hOwner()
{

	static std::uintptr_t tt = netvars.GetOffset("DT_BaseViewModel", "m_hOwner");
	return *(CBaseHandle*)((std::uintptr_t)this + tt);
}
CBaseHandle IBaseViewModel::m_hWeapon()
{

	static std::uintptr_t tt = netvars.GetOffset("DT_BaseViewModel", "m_hWeapon");
	return *(CBaseHandle*)((std::uintptr_t)this + tt);
}
...
int& IBaseCombatWeapon::m_iWorldModelIndex()
{
	static DWORD tt = netvars.GetOffset("DT_BaseCombatWeapon", "m_hWorldModelIndex");
	return *(int*)((uintptr_t)this + tt);
}


IBaseCombatWeapon* IBaseCombatWeapon::m_hWeaponWorldModel()
{
	//static DWORD tt = netvars.GetOffset("DT_BaseCombatWeapon", "m_iWorldModelIndex");
	//static auto tt = *(CCBaseHandle*)((uintptr_t)this + netvars.GetOffset("DT_BaseCombatWeapon", "m_hWeaponWorldModel"));
	//return reinterpret_cast<IBaseCombatWeapon*>(interfaces.ent_list->Shonax_GetClientEntityFromHandle(tt));

	static auto tt = ((uintptr_t)this + netvars.GetOffset("DT_BaseCombatWeapon", "m_iWorldModelIndex"));
	return reinterpret_cast<IBaseCombatWeapon*>(interfaces.ent_list->GetClientEntityFromHandle(tt));
...
int& IBaseCombatWeapon::get_item_id_low()
{
	static int offset = netvars.GetOffset("DT_BaseAttributableItem", "m_iItemIDLow");
	return *(int*)((uintptr_t)this + offset);
}
int& IBaseCombatWeapon::get_item_id_high()
{
	static int offset = netvars.GetOffset("DT_BaseAttributableItem", "m_iItemIDHigh");
	return *(int*)((uintptr_t)this + offset);
}
short& IBaseCombatWeapon::get_item_definition_index()
{
	static int offset = netvars.GetOffset(hs::DT_BaseAttributableItem::s().c_str(), hs::m_iItemDefinitionIndex::s().c_str());
	return *(short*)((uintptr_t)this + offset);
}
int& IBaseCombatWeapon::get_account_id()
{
	static int offset = netvars.GetOffset("DT_BaseAttributableItem", "m_bInitialized");
	return *(int*)((uintptr_t)this + offset);
}
bool& IBaseCombatWeapon::is_initialized()
{
	static int offset = netvars.GetOffset("DT_BaseAttributableItem", "m_bInitialized");
	return *(bool*)((uintptr_t)this + offset);
}

void IBaseCombatWeapon::SetGloveModelIndex(int index) {
	typedef void(__thiscall* SetModelIndexFn)(void*, int);
	call_v_func<SetModelIndexFn>(this, 75)(this, index);
}

unsigned& IBasePlayer::get_body()
{
	static int offset = netvars.GetOffset("DT_BaseAnimating", "m_nBody");
	return *(unsigned*)((uintptr_t)this + offset);
}
...
inline CCBaseHandle::CCBaseHandle()
{
	m_Index = INVALID_EHANDLE_INDEX;
}

inline CCBaseHandle::CCBaseHandle(const CCBaseHandle& other)
{
	m_Index = other.m_Index;
}

inline CCBaseHandle::CCBaseHandle(unsigned long value)
{
	m_Index = value;
}

inline CCBaseHandle::CCBaseHandle(int iEntry, int iSerialNumber)
{
	Init(iEntry, iSerialNumber);
}

inline void CCBaseHandle::Init(int iEntry, int iSerialNumber)
{
	m_Index = iEntry | (iSerialNumber << NUM_ENT_ENTRY_BITS);
}

inline void CCBaseHandle::Init(int iEntry, int iSerialNumber, int iBits)
{
	m_Index = iEntry | (iSerialNumber << iBits);
}

inline void CCBaseHandle::Term()
{
	m_Index = INVALID_EHANDLE_INDEX;
}

inline bool CCBaseHandle::IsValid() const
{
	return m_Index != INVALID_EHANDLE_INDEX;
}

inline int CCBaseHandle::GetEntryIndex() const
{
	return m_Index & ENT_ENTRY_MASK;
}

inline int CCBaseHandle::GetSerialNumber() const
{
	return m_Index >> NUM_ENT_ENTRY_BITS;
}

inline int CCBaseHandle::ToInt() const
{
	return (int)m_Index;
}

inline bool CCBaseHandle::operator !=(const CCBaseHandle& other) const
{
...
inline bool CCBaseHandle::operator ==(const IHandleEntity* pEnt) const
{
	return Get() == pEnt;
}
...
inline const CCBaseHandle& CCBaseHandle::operator=(const IHandleEntity* pEntity)
{
	return Set(pEntity);
}

inline const CCBaseHandle& CCBaseHandle::Set(const IHandleEntity* pEntity)
{
	if (pEntity) {
