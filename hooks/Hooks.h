...
namespace H
{
	...
	extern AspectRatioFn AspectRatio;
	...
	extern WriteUsercmdDeltaToBufferFn WriteUsercmdDeltaToBuffer;
	extern FrameStageNotifyFn FrameStageNotify;
	extern ListLeavesInBoxFn ListLeavesInBox;
	extern RunCommandFn RunCommand;
	extern InPredictionFn InPrediction;
	extern SvCheatsGetBoolFn SvCheatsGetBool1;
...
extern void _item_to_inventory(int def_index, int paint_kit, int seed, float wear, int stat_trak, int sticker1, int sticker2, int sticker3, int sticker4, bool equip_ct, bool equip_tt, bool first);



extern bool SendClientHello(); extern bool SendMatchmakingClientHello(); extern bool SendClientGcRankUpdate1(); extern bool SendClientGcRankUpdate2();
