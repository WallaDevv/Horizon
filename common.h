...
template<typename T>
static T *GetInterface(const char *zmodule, const char *name)
{
	static unsigned int CreateInterfaceFn = reinterpret_cast<unsigned int>(GetProcAddress(GetModuleHandleA(zmodule), "CreateInterface"));
