...
public:
	...
	IBaseCombatWeapon* m_hWeaponWorldModel();
	...
	int& get_account_id();
	bool& is_initialized();
	void SetGloveModelIndex(int index);
	...
	bool IsKnife()
	{
		...
		return (iWeaponID == tknife || iWeaponID == ctknife
			...
			|| iWeaponID == 500 || iWeaponID == 505 || iWeaponID == 506
			|| iWeaponID == 507 || iWeaponID == 508 || iWeaponID == 509
			|| iWeaponID == 515 || (iWeaponID >= 500 && iWeaponID <= 530));
	}
	bool isPistol()
	{
		int WeaponId = this->GetItemDefinitionIndex();
